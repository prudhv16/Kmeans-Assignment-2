...
def KMean(data,CNumber,threshold):
	...
	#Calculate distance between centroids and see if its less than a throusheld if yes, re-select centroids if no continue.
    convergence = 10000
    while True:
		#Calculate distance between centroids and see if its less than a throusheld if yes, get median of two centroids and then assign 
		#a value less than median to one centroid and assign value more than median to other centroids.
		#redo above step untill distance is more than Tc.
